...
const Explore: React.FC<ExploreProps> = ({ onUserClick }) => {
  ...
  const filteredPosts = posts.filter(post => {
    ...
    return postUser?.username.toLowerCase().includes(searchQuery.toLowerCase()) ||
    ...
    <div className="py-4">
      ...
      {searchQuery ? (
        ...
        <div>
          ...
          {users.length > 0 && (
            <div className="mb-8">
              <h3 className="text-lg font-medium text-gray-800 mb-4">Suggested for you</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {users.slice(0, 6).map((user) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-blue-500 font-medium">View Profile</div>
                  </button>
                ))}
              </div>
            </div>
          ...
          {posts.length > 0 ? (
            <div>
              <h3 className="text-lg font-medium text-gray-800 mb-4">Explore</h3>
              <div className="grid grid-cols-3 gap-1 md:gap-4">
                {posts.map((post) => (
                  <div
                    key={post.id}
            ...
            <div className="text-center py-20">
              <div className="text-gray-500">
                ...
                <h3 className="text-lg font-medium text-gray-800 mb-2">Nothing to explore yet</h3>
                <p className="text-gray-600">When people share posts, you'll see them here.</p>
              </div>
            </div>
          )}
        </div>
